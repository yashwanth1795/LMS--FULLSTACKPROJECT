...
const menu = [
  ...
  { label: 'Profile', to: '/instructor/profile', icon: UserCircle2 }
]
...
const InstructorSidebar = ({ open, onClose }) => (
  <motion.aside
    initial={false}
  ...
  >
    <div className="mb-5 flex items-center gap-2 px-1">
      ...
      <div>
        <p className="font-display text-lg">Instructor Hub</p>
        <p className="text-xs text-slate-500">Udemy-style workspace</p>
      </div>
    </div>
